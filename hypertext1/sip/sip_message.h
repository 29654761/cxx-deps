...
class sip_message:public base_message
{
public:
	sip_message();
	~sip_message();
	...
	static sip_message create_request(const std::string& method,const voip_uri& url, uint32_t cseq,const std::vector<sip_via>& vias);
